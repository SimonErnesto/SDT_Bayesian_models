...
az.plot_trace(idata_base.posterior, var_names=["d", "c", "H", "F"], kind="rank_vlines")
plt.suptitle("A  Model 1 (Base Model)", x=0.12)
plt.tight_layout()
plt.savefig("mod1_rank_plots.png", dpi=300)
plt.show()
plt.close()
...
az.plot_trace(idata_var.posterior, var_names=["d", "c", "H", "F"], kind="rank_vlines")
plt.suptitle("B  Model 2 (Varying Model)", x=0.13)
plt.tight_layout()
plt.savefig("mod2_rank_plots.png", dpi=300)
plt.show()
plt.close()
...
az.plot_trace(idata_lkj.posterior, var_names=["ρ high", "ρ low", "d", "c", "H", "F"], kind="rank_vlines")
plt.suptitle("C  Model 3 (LKJ Model)", x=0.12)
plt.tight_layout()
plt.savefig("mod3_rank_plots.png", dpi=300)
plt.show()
plt.close()
