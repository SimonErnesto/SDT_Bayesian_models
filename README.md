...
<p align="center">
	<img src="simulations/simulations_summary.png" width="800" height="400" />
</p>
...
<p align="center">
	<img src="prior_predictions/prior_plots.png" width="600" height="500" />
</p>
...
<p align="center">
	<img src="model_convergence/rank_plots.png" width="650" height="500" />
</p>

<p> Next we perform a precision analysis, to see whether precision is good enough after 100 samples (i.e. 100 per group). All models reached a reasonable precision of around 0.1, but Model 1's central tendency did not approach simulated values of <i>d'</i> and <i>c</i>. </p>

<p align="center">
	<img src="precision_analysis/precision_plots.png" width="700" height="500" />
</p>

<p> After this, we assessed posteriors via scatter plots and Hellinger <i>H<sup>2</sup></i> distance measure (see Pardo, 2018), to see how much the posterior distributions of <i>d'</i> and <i>c</i> differed from their observed (simulated) counterparts. Image below summarises these results, where models 2 and 3 approximated sensitivity and bias much better than Model 1.  </p>

<p align="center">
	<img src="model_posteriors/posterior_plots.png" width="700" height="500" />
</p>
...
<p align="center">
	<img src="posterior_predictions/prediction_plots.png" width="700" height="500" />
</p>
...
<p align="center">
	<img src="model_comparison/model_comp_loo.png" width="500" height="300" />
</p>
