...
axs[0,0].plot(n, dhm, color="g", label="Posterior Mean")
...
axs[0,1].plot(n, dlm, color="g", label="Posterior Mean")
...
axs[1,0].plot(n, chm, color="g", label="Posterior Mean")
...
axs[1,1].plot(n, clm, color="g", label="Posterior Mean")
...
plt.tight_layout()
plt.savefig("mod1_precision.png", dpi=300)
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig("mod2_precision.png", dpi=300)
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig("mod3_precision.png", dpi=300)
plt.show()
plt.close()
