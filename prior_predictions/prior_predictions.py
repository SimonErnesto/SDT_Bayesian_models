...
axs[0,0].text(s="Model 1 (Base Model)", x=-1, y=35, size=20)

plt.tight_layout()
plt.savefig("mod1_prior_predictives.png", dpi=300)
plt.show()
plt.close()
...
axs[0,0].text(s="Model 2 (Varying Model)", x=-1, y=35, size=20)

plt.tight_layout()
plt.savefig("mod2_prior_predictives.png", dpi=300)
plt.show()
plt.close()
...
axs[0,0].text(s="Model 3 (LKJ Model)", x=-1, y=35, size=20)

plt.tight_layout()
plt.savefig("mod3_prior_predictives.png", dpi=300)
plt.show()
plt.close()
